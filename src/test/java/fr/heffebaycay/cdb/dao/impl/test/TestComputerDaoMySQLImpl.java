...
public class TestComputerDaoMySQLImpl {
  ...
  public void setUp() throws Exception {
    ...
    final Computer comp1 = new Computer.Builder()
                      .id(1)
                      .company(c1)
                      .name("MacBook Pro 15.4 inch")
                      .build();

    final Computer comp2 = new Computer.Builder()
                      .id(2)
                      .name("HP Awesome Computer")
                      .introduced(LocalDateTime.parse("2013-01-06T00:00:00"))
                      .company(c2)
                      .build();

    final Computer comp3 = new Computer.Builder()
                    .id(3)
                    .name("HP Oldie")
                    .introduced(LocalDateTime.parse("1998-06-12T00:00:00"))
                    .discontinued(LocalDateTime.parse("2001-10-25T00:00:00"))
                    .company(c2)
                    .build();

    final Computer comp4 = new Computer.Builder()
                    .id(4)
                    .name("Acer Inspire o/")
                    .introduced(LocalDateTime.parse("2003-12-25T00:00:00"))
                    .discontinued(LocalDateTime.parse("2007-02-02T00:00:00"))
                    .company(c5)
                    .build();

    final Computer comp5 = new Computer.Builder()
                  .id(5)
                  .name("A Computer With No Company")
                  .introduced(LocalDateTime.parse("1975-12-01T00:00:00"))
                  .discontinued(LocalDateTime.parse("1980-01-01T00:00:00"))
                  .build();

    final Computer comp6 = new Computer.Builder()
                  .id(6)
                  .name("MacBook Pro")
                  .company(c1)
    ...
    final Computer comp7 = new Computer.Builder()
                  .id(7)
  ...
  public void testCreate() {
    ...
    Computer computer = new Computer.Builder()
                                        ...
                                        .discontinued(LocalDateTime.parse("2015-01-01T00:00:00"))
                                        .company(company)
                                        .build();
